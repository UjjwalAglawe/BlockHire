                    ...
                    <div className="px-6 pb-6">
                        <div className="flex flex-col sm:flex-row items-start sm:items-end -mt-20 mb-6 relative z-10">
                            ...
                            <div className="mt-5 sm:mt-0">
                                {currentUser.metamaskAddress ? (
                                    <p className="text-gray-700">{currentUser.metamaskAddress}</p>
                                ) : (
                        ...
                        {/* <div className="mb-6">
                            {currentUser.bio ? (
                                ...
                                <div className="text-gray-500 border border-dashed border-gray-300 rounded-md p-5 text-center">
                                    {currentUser.isOwnProfile ? 'Add a bio to tell people about yourself' : 'No bio yet'}
                                </div>
                            )}
                        </div> */}
                    </div>
